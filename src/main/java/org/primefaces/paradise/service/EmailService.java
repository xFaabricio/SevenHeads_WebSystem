...
public class EmailService {
	...
	public void sendEmailWelcome(String to, String name) throws MessagingException {
		sendEmailWelcome(to, name, false);
	}
	
	@SuppressWarnings("deprecation")
	public void sendEmailWelcome(String to, String name, boolean debugTest) throws MessagingException {
        try {
            ...
            String body = templateHtmlWelcome(name);
